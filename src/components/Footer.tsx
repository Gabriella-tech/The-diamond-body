    ...
    <footer className="bg-[#222222] text-gray-300 mt-20">
      <Container className="py-16">
        <div className="grid lg:grid-cols-4 gap-10">
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2"><IconMail size={16} />thediamondbodynigeria@gmail.com </div>
              <div className="flex items-center gap-2"><IconPhone size={16} /> +234 7025008596</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/shop?cat=coffee" className="hover:text-white">Coffee & Wellness</Link></li>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <div>© 2026 Diamond Body Nig. All rights reserved.</div>
