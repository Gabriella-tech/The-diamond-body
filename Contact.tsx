        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="space-y-4">
            {[
              ...
              { i: <IconPhone size={22}/>, t: "Phone", d: "+234 7025008596", s: "Mon–Sat, 9am–6pm" },
              ...
              <div key={i} className="bg-white border border-gray-100 rounded-2xl p-6 flex gap-4">
                ...
                <div>
                  ...
                  <div className="text-[#4A0E16] font-semibold text-sm">{c.t === "Email" ? (
                    <a href={`mailto:${c.d}`} className="hover:underline">
                      {c.d}
                    </a>
                  ) : (
                    c.d
          ...
          <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl p-8">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <a  
                 href={`mailto:thediamondbodynigeria@gmail.com?subject=${encodeURIComponent(form.subject)}&body=${encodeURIComponent(
               `Name: ${form.name}
              ...
              ${form.message}`
                ...
                className="inline-block w-full text-center bg-[#4A0E16] text-white py-3 rounded-lg hover:bg-[#5e1520]"
              >
                 Send us an email
              </a>
            </form>
